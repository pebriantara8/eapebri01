...
input double timeFirst = 12;
input double timeLast = 16;
...
void OnTick()
{
  ...
  if (bNewBarEvent)
  {
    GlobalVariableSet("timeNewDay", (datetime)TimeCurrent());
  }
  else
  {
    if (!GlobalVariableGet("timeNewDay"))
    {
      GlobalVariableSet("timeNewDay", (datetime)TimeCurrent());
    }
  }
  ...
  datetime time1 = (datetime)GlobalVariableGet("timeNewDay") + timeFirst * 3600;
  datetime time2 = (datetime)GlobalVariableGet("timeNewDay") + timeLast * 3600;
  Print(time1);
